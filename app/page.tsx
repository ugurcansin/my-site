            ...
            <header className="sticky top-0 z-50 border-b border-black/5 bg-white/70 backdrop-blur-xl">
                <div className="mx-auto flex max-w-md items-center justify-between px-4 py-4">
                    ...
                    <nav className="flex items-center gap-4 text-sm text-slate-700">
                        ...
                        <a className="hover:text-slate-950 transition" href="mailto:support@putmyfacein.com">
                            Contact
                        </a>
                    </nav>
                </div>
            ...
            <main className="mx-auto max-w-md px-4">
                ...
                <section className="pt-7 pb-4 text-center">
                    ...
                    <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed text-slate-600">
                        Upload a selfie → pay <span className="font-semibold text-slate-900">${PRICE.toFixed(2)}</span> →
                ...
                <section id="templates" className="pb-10">
                    <div className="mb-3 text-center">
                        <p className="text-xs font-semibold tracking-[0.35em] text-slate-600">TEMPLATE</p>
                        <p className="mt-1 text-sm text-slate-600">Tap to preview · Tap again to open</p>
                    </div>
                            ...
                            <div key={t.slug} className="text-center">
                                ...
                                <div className="mt-3">
                                    <div className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white/75 px-4 py-2 shadow-sm">
                                        <span className="text-xs text-slate-500 line-through">${ORIGINAL_PRICE.toFixed(2)}</span>
                ...
                <section className="pb-12">
                    <div className="rounded-2xl border border-black/10 bg-white/70 p-4 text-center shadow-sm">
                        <p className="text-sm font-semibold text-slate-900">
                            Limited launch price: <span className="text-indigo-700">${PRICE.toFixed(2)}</span>
                        </p>
